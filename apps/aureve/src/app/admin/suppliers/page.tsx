  ...
  return (
    <div style={{ padding: '2.5rem', background: 'var(--cream)', minHeight: '100vh' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: selected ? '1fr 340px' : '1fr', gap: '1.5rem' }}>
        ...
        {/* Detail panel */}
        {selected && (
<div style={{ background: '#fff', borderRadius: '16px', border: '1px solid rgba(201,168,76,0.2)', padding: '1.75rem', height: 'fit-content', position: 'relative', boxShadow: '0 4px 20px rgba(201,168,76,0.08)', overflow: 'hidden' }}>
